...
const CATEGORIES=['Todas','Chapas IBR','Pregos','Ferros','Tubos','Cimentos','Eletrodos','Arames','Materiais e acessórios','Ferramentas','Segurança e sinalização','Casa e hidráulica','Construção e manutenção','Ferragens e ferramentas','Outros produtos'];
...
function categoryMark(category) {
  const marks= {
    'Chapas IBR':'IBR','Pregos':'PG','Ferros':'FE','Tubos':'TB','Cimentos':'CM','Eletrodos':'EL','Arames':'AR','Materiais e acessórios':'MA','Ferramentas':'FT','Segurança e sinalização':'SS','Casa e hidráulica':'CH','Construção e manutenção':'CO','Ferragens e ferramentas':'FH','Outros produtos':'OT'
  }
  ;
